let mymap = L.map("map").setView([30, 32], 5);
      ...
      marker2.bindPopup("<b>Alexandariah</b>").openPopup();
      ...
      marker6.bindPopup("<b> Dubai is waitting you</b>").openPopup();
      marker7.bindPopup("<b> Dahab is waitting you</b>").openPopup();
      marker8.bindPopup("<b> Hurghada is waitting you</b>").openPopup();