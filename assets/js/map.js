let mymap = L.map("map").setView([30, 32], 5);
      ...
      marker7.bindPopup("<b> Dahab is waitting for you</b>").openPopup();
      marker8.bindPopup("<b> Hurghada is waitting for you</b>").openPopup();
      marker6.bindPopup("<b> Dubai is waitting for you</b>").openPopup();